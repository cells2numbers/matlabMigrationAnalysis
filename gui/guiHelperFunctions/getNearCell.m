function nearCells = getNearCell(tLng,time,position,varargin)
% getNearCell returns all cells near a given position at a given time
% 
%   [pathlist] = getNearcell(tLng,time,position,varargin)
%
%   optional argument: 
...
%   position = [50,50];
%   radius = 100; 
%   nearCell = getNearCell(tLng,time,position,'radius',radius)
%
% t.b. jan. 2010
radius = 80;
